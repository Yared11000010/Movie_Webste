...
import Logo from '../assets/3698776.png';
...
const Header = () => {
    ...
    return (
       <header>
        ...
        <NavLink to="/" className="flex items-center" activeClassName={activeClass} exact>
                        <img src={Logo} className="h-8 mr-3" alt="Flowbite Logo" />
                        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">YMovie</span>
         </NavLink>
        ...
        {/* mobile */}
            ...
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <NavLink to="/" className={({isActive}) => isActive ? activeClass : inActiveClass} exact>Home</NavLink>
                        </li>
                        <li>
